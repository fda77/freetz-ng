$(call PKG_INIT_BIN, $(if $(FREETZ_PACKAGE_UNRAR_VERSION_ABANDON),6.1.7,7.1.8))
...
$(PKG)_HASH_CURRENT:=9ec7765a948140758af12ed29e3e47db425df79a9c5cbb71b28769b256a7a014
...
$(PKG)_DEPENDS_ON += libstdcxx $(STDCXXLIB)
